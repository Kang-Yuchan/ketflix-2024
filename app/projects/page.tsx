...
export default function Projects() {
  ...
  return (
    <div className="w-full flex-1">
      <section className="w-full bg-background py-12 dark:bg-foreground md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-4">
                <h1 className="text-3xl font-bold tracking-tighter text-[#121212] sm:text-5xl xl:text-6xl/none">
                  Projects
                </h1>
                <p className="max-w-[600px] text-[#121212] md:text-xl">
